    ...
    <div className="space-y-6 max-w-lg">
      ...
      >
        <div
          ...
          style={{ background: 'var(--md-on-secondary-container)', opacity: 0.12 }}
          aria-hidden
        />
        <div
          className="absolute w-12 h-12 rounded-full flex items-center justify-center shrink-0 pointer-events-none"
          aria-hidden
        >
          {/* Person icon */}
